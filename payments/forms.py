...
class PaymentForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['price'].widget.attrs['style'] = "width:120px;margin:15px 10px 20px 0px;border:none"
    ...
    class Meta:
        ...
        widgets = {
            ...
            'address': forms.TextInput(attrs = {'class': 'form-control buyer_address', 'value':'Saturn 15', 'placeholder': 'Your street number, building and apartment...'}),
            ...
            'phone': forms.TextInput(attrs = {'class': 'form-control buyer_phone','value':'0757484560', 'placeholder': 'Your phone number...'}),
            'email': forms.EmailInput(attrs = {'class': 'form-control', 'value':'danielungureanu531@gmail.com', 'placeholder': 'Your email...'}),
