...
class Payment(models.Model):
    ...
    country = CountryField(blank_label="Type first letters of your country of residence...",blank=True, null=True)
...
class Ticket(models.Model):
    ...
    buyer_fname = models.CharField(max_length=100)
    buyer_lname = models.CharField(max_length=100)
    ticket_series =  models.CharField(max_length=30, default="DBPNO-")
    ticket_nr = models.CharField(max_length=10)
