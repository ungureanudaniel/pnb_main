...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" size="" format="" mimeType="" name="Personal GeoDatabase Feature Class" url="file://\\PAZA\D$\GIS\BUCEGI GIS 2009\GIS_TURISTIC_PNB.mdb" type="Local Area Network"/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial miny="414153.19762900000205263" minx="525920.84203199995681643" dimensions="2" maxy="449998.85562799999024719" minz="0" crs="EPSG:4326" maxx="542463.59099099994637072" maxz="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
